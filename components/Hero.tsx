...
const Hero = () => {
    return (
        <div className="py-6 bg-hero-pattern3  bg-no-repeat bg-cover   md:min-h-[90vh]">

            <div className='flex flex-col justify-center items-center md:p-16'>
                <div className="hero-text md:mt-8 p-2">
                    <p className='text-ag-gold font-bold text-left md:text-center text-4xl md:text-[40px] lg:text-[60px] leading-relaxed md:leading-loose uppercase drop-shadow-lg'>
